...
from fastmri.pl_modules import FastMriDataModule, UtransformerModule
...
def build_args():
    ...
    default_root_dir = fetch_dir("log_path", path_config) / "utransformer" / "transformer_demo"
    ...
    # module config
    parser = UtransformerModule.add_model_specific_args(parser)
    parser.set_defaults(
